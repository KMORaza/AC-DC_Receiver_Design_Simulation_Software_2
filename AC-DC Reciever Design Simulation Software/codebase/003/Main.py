...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.timer.start(50)  # Reduced to 50 ms for smoother updates
    ...
    def update_plots(self):
        ...
        # Generate fresh waveform data
        t = np.linspace(0, 0.1, 1000)
        ac_signal, rectified_signal, modulated_signal = self.model.generate_waveform(t)

        # Ensure harmonic analyzer updates first to get latest THD+N
        self.harmonic_analyzer.update_plots()
        ...
        try:
            ...
            efficiency = self.model.efficiency * 100
