...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.stability_analyzer = StabilityAnalyzer(self.model)  # Initialize StabilityAnalyzer
        self.init_ui()
        self.timer = QTimer()
    ...
    def init_ui(self):
        ...
        splitter.addWidget(self.stability_analyzer.get_widget())

        splitter.setSizes([600, 1000, 600])  # Adjusted sizes to accommodate stability plots
    ...
    def update_plots(self):
        if not self.model.power_on:
            ...
            self.stability_analyzer.update_plots()  # Clear stability plots
